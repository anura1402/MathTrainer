...
public class Squares extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (toolbar != null){
            toolbar.setTitle("Площади фигур");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(Squares.this, Jump_trainer.class);
                intent.putExtra("EXTRA_NEXT_ACTIVITY_CLASS", Squares.class);
                intent.putExtra("activity_name", "Squares");
