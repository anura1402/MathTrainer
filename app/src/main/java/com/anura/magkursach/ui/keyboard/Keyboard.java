...
public class Keyboard extends LinearLayout implements View.OnClickListener {
    ...
    private MathView mv_formula, mv_test;
    ...
    public void set_view(MathView view_display, ArrayList<String> leftQ, ArrayList<String> rightQ) {
        reset_text();
        Log.d("TAG1","left1 "+left+" right1 "+right);
        // The display view is used to show the formula\
        left = leftQ;
        right = rightQ;
        //добавление полученной левой части от курсора
        ...
        text.append(".");
        text.append(".");
        //добавление полученной правой части от курсора
        StringBuilder textR = new StringBuilder();
        for (int i = 0; i < right.size(); i++) {
            textR.append(right.get(i));
        }
        mv_formula = view_display;
        String text1 = text.toString();
        String text2 = textR.toString();
        mv_formula.setText("$$" + text1 + " " + text2 + "$$");
    ...
    private void initialize_keyboard(Context context) {
        ...
        int[] ids = {
                R.id.bt_equal, R.id.btX, R.id.btY, R.id.btZ, R.id.bt_tg, R.id.bt_ctg, R.id.bt_check,
                R.id.bt_plus, R.id.bt1, R.id.bt2, R.id.bt3, R.id.bt_klL, R.id.bt_klR, R.id.bt_empty,
                ...
                R.id.bt_frac, R.id.bt_dec, R.id.bt0, R.id.bt_pi, R.id.bt_down, R.id.bte, R.id.bt_cos
        };
        String[] values = {
                "=", "x", "y", "z", "tg(", "ctg(", "",
                "+", "1", "2", "3", "(", ")", "",
    ...
    public void reset_text() {
        ...
        left = new ArrayList<>();
        right = new ArrayList<>();
        Log.d("TAG1","left0 "+left+" right0 "+right);
    }
    ...
    public String get_latex_text() {
        ...
        Log.d("TAG1", "left = " + left.toString() + " right " + right.toString() + " text " + text.toString());
